 ...
 * @author visitante
 */
public class MDI_EF extends javax.swing.JFrame {
    ...
    public MDI_EF() {
        ...
        this.setExtendedState(MDI_EF.MAXIMIZED_BOTH);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(MDI_EF.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
